...
using VetAppoinment.Models.Dtos.General;
...
namespace VetAppoinment.Models.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager,IConfiguration configuration, IHubContext<ChatHub> hubContext)
        {
        ...
        public async Task<GeneralServiceResponseDto> RegisterAsync(RegisterDto registerDto)
        {
            ...
            // If this is the first registered user, assign the OWNER role
